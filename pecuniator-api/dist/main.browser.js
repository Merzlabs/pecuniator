...
},{"./camt":1,"./klarna":2,"camtts":5}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var AccountReport_1 = require("./types/AccountReport");
var CAMT = /** @class */ (function () {
    function CAMT() {
    }
    CAMT.parse = function (toparse) {
        var parser;
        // Use native DOMParser in Browser and package in NodeJS
        if (typeof DOMParser === 'undefined') {
            var NodeParser = require('xmldom').DOMParser;
            parser = new NodeParser();
        }
        else {
            parser = new DOMParser();
        }
        var xml = parser.parseFromString(toparse, 'text/xml');
        //Support for camt.052 Bank to Customer Account Report
        var report = new AccountReport_1.AccountReport(xml);
        return report;
    };
    return CAMT;
}());
...
},{"./types/AccountReport":6,"xmldom":10}],6:[function(require,module,exports){
"use strict";
...
},{"./Base":7,"./Report":9}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var CAMTElement = /** @class */ (function () {
    function CAMTElement(element) {
...
var Entry = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Entry.prototype, "reference", {
        get: function () {
            var _a, _b;
            return (_b = (_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('NtryRef')[0]) === null || _b === void 0 ? void 0 : _b.textContent;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Entry.prototype, "amount", {
        get: function () {
            var _a, _b, _c, _d;
            var value = (_b = (_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('Amt')[0]) === null || _b === void 0 ? void 0 : _b.textContent;
            var currency = (_d = (_c = this.element) === null || _c === void 0 ? void 0 : _c.getElementsByTagName('Amt')[0]) === null || _d === void 0 ? void 0 : _d.getAttribute('Ccy');
            return { value: value, currency: currency };
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Entry.prototype, "creditdebitIndicator", {
        get: function () {
            var _a, _b;
            return (_b = (_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('CdtDbtInd')[0]) === null || _b === void 0 ? void 0 : _b.textContent;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Entry.prototype, "bookindDate", {
        get: function () {
            var _a, _b, _c;
            var bookingDate = (_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('BookgDt')[0];
            return { date: (_c = (_b = bookingDate) === null || _b === void 0 ? void 0 : _b.getElementsByTagName('Dt')[0]) === null || _c === void 0 ? void 0 : _c.textContent };
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Entry.prototype, "accountServiceRef", {
        get: function () {
            var _a, _b;
            return (_b = (_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('AcctSvcrRef')[0]) === null || _b === void 0 ? void 0 : _b.textContent;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Entry.prototype, "additionalEntryInfo", {
        get: function () {
            var _a, _b;
            return (_b = (_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('AddtlNtryInf')[0]) === null || _b === void 0 ? void 0 : _b.textContent;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Entry.prototype, "entryDetails", {
        get: function () {
            var _a;
            return new EntryDetails((_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('NtryDtls')[0]);
        },
        enumerable: true,
        configurable: true
    });
...
exports.Entry = Entry;
var EntryDetails = /** @class */ (function (_super) {
    __extends(EntryDetails, _super);
    function EntryDetails() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(EntryDetails.prototype, "transactionDetails", {
        get: function () {
            var _a;
            return new TransactionDetails((_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('TxDtls')[0]);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(EntryDetails.prototype, "remittanceInformation", {
        /**
         * Subject / Verwendungszweck
         */
        get: function () {
            var _a;
            return new RemittanceInformation((_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('RmtInf')[0]);
        },
        enumerable: true,
        configurable: true
    });
...
var TransactionDetails = /** @class */ (function (_super) {
    ...
    Object.defineProperty(TransactionDetails.prototype, "relatedParties", {
        get: function () {
            var _a;
            return new RelatedParties((_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('RltdPties')[0]);
        },
        enumerable: true,
        configurable: true
    });
...
var RelatedParties = /** @class */ (function (_super) {
    __extends(RelatedParties, _super);
    function RelatedParties() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(RelatedParties.prototype, "debitorAccount", {
        /**
         * Financial institution for the creditor/ Zahlungsdienstleister des Debtors
         */
        get: function () {
            var _a, _b, _c, _d;
            var acc = (_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('DbtrAcct')[0];
            var iban = (_d = (_c = (_b = acc) === null || _b === void 0 ? void 0 : _b.getElementsByTagName('Id')[0]) === null || _c === void 0 ? void 0 : _c.getElementsByTagName('IBAN')[0]) === null || _d === void 0 ? void 0 : _d.textContent;
            return { id: { iban: iban } };
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RelatedParties.prototype, "debtor", {
        /**
         * Debtor / Zahler
         */
        get: function () {
            var _a, _b, _c;
            var acc = (_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('Dbtr')[0];
            var name = (_c = (_b = acc) === null || _b === void 0 ? void 0 : _b.getElementsByTagName('Nm')[0]) === null || _c === void 0 ? void 0 : _c.textContent;
            return { name: name };
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RelatedParties.prototype, "ultimateDebtor", {
        /**
         * Ultimate debitor different from creditor / Abweichender Zahler
         */
        get: function () {
            var _a, _b, _c;
            var acc = (_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('UltmtDbtr')[0];
            var name = (_c = (_b = acc) === null || _b === void 0 ? void 0 : _b.getElementsByTagName('Nm')[0]) === null || _c === void 0 ? void 0 : _c.textContent;
            return { name: name };
        },
        enumerable: true,
    ...
    Object.defineProperty(RelatedParties.prototype, "creditorAccount", {
        /**
         *  ID of creditor account / Zahlungsdienstleister des Creditors
         */
        get: function () {
            var _a, _b, _c, _d;
            var acc = (_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('CdtrAcct')[0];
            var iban = (_d = (_c = (_b = acc) === null || _b === void 0 ? void 0 : _b.getElementsByTagName('Id')[0]) === null || _c === void 0 ? void 0 : _c.getElementsByTagName('IBAN')[0]) === null || _d === void 0 ? void 0 : _d.textContent;
            return { id: { iban: iban } };
        },
        enumerable: true,
    ...
    Object.defineProperty(RelatedParties.prototype, "creditor", {
        /**
         * Party to which amount of money is due / Einreicher der Lastschrift
         */
        get: function () {
            var _a, _b, _c;
            var acc = (_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('Cdtr')[0];
            var name = (_c = (_b = acc) === null || _b === void 0 ? void 0 : _b.getElementsByTagName('Nm')[0]) === null || _c === void 0 ? void 0 : _c.textContent;
            return { name: name };
        },
        enumerable: true,
    ...
    Object.defineProperty(RelatedParties.prototype, "ultimateCreditor", {
        /**
         * Ultimate party to which an amount of money is due. / Konto des Lastschrifteinreichers
         */
        get: function () {
            var _a, _b, _c;
            var acc = (_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('UltmtCdtr')[0];
            var name = (_c = (_b = acc) === null || _b === void 0 ? void 0 : _b.getElementsByTagName('Nm')[0]) === null || _c === void 0 ? void 0 : _c.textContent;
            return { name: name };
        },
        enumerable: true,
...
var RemittanceInformation = /** @class */ (function (_super) {
    __extends(RemittanceInformation, _super);
    function RemittanceInformation() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(RemittanceInformation.prototype, "unstructured", {
        get: function () {
            var _a;
            return Array.prototype.map.call((_a = this.element) === null || _a === void 0 ? void 0 : _a.getElementsByTagName('Ustrd'), function (elem) {
...
},{"./Base":7,"./Entry":8}],10:[function(require,module,exports){
